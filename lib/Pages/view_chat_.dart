...
class _UserChatViewState extends State<UserChatView> {
  ...
  addmessage() async {
    ...
    var url = "http://192.168.120.86/automated_payrole/chat_user.php";
    var data = {
      "Login_id": loginId,
      "message": Message,
    };
  ...
  getChatResultdata() async {
    ...
    var url = "http://192.168.68.127/automated_payrole/viewchat.php";
    var data = {
      "Login_id": loginId,
    };
    ...
    child: Card(
      ...
      children: [
        ...
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Row(
            children: [Container(child: Text("replay:  ${replay}"))],
          ),
        )
      ],
    )),
